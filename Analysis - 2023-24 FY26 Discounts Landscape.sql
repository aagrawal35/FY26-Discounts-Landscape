...
-- DBTITLE 1,Commerce Pricing Segment Pipeline - 2024

DROP VIEW IF EXISTS commerce_pricing_segment_ty24_12;
CREATE TEMP VIEW commerce_pricing_segment_ty24_12 as
Select
...
DROP VIEW IF EXISTS commerce_pricing_segment_ty24_1_2;
CREATE TEMP VIEW commerce_pricing_segment_ty24_1_2 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
DROP VIEW IF EXISTS commerce_pricing_segment_ty24_3_4;
CREATE TEMP VIEW commerce_pricing_segment_ty24_3_4 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
DROP VIEW IF EXISTS commerce_pricing_segment_ty24_5_6;
CREATE TEMP VIEW commerce_pricing_segment_ty24_5_6 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
DROP VIEW IF EXISTS commerce_pricing_segment_ty24_7_8;
CREATE TEMP VIEW commerce_pricing_segment_ty24_7_8 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
WHERE 1 = 1
  ...
  DROP VIEW IF EXISTS commerce_pricing_segment_ty24_9_10;
CREATE TEMP VIEW commerce_pricing_segment_ty24_9_10 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
DROP VIEW IF EXISTS commerce_pricing_segment_ty24_v;
CREATE TEMP VIEW commerce_pricing_segment_ty24_v as
select tax_year
  , auth_id
  , productFamily
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty24_1_2
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty24_3_4
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty24_5_6
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty24_7_8
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty24_9_10
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7;


DROP VIEW IF EXISTS commerce_pricing_segment_ty24_v2;
CREATE TEMP VIEW commerce_pricing_segment_ty24_v2 as
...
SELECT
  ...
  FROM commerce_pricing_segment_ty24_v;

CREATE table if not exists cgan_ustax_ws.commerce_pricing_segment_ty24 as
SELECT 
    tax_year,
    auth_id,
    productFamily,
    ...
    min_rank,
    max_rank
FROM commerce_pricing_segment_ty24_v2
WHERE min_rank = 1 OR max_rank = 1

-- COMMAND ----------

-- DBTITLE 1,Commerce Pricing Segment Pipeline - 2023



DROP VIEW IF EXISTS commerce_pricing_segment_ty23_12;
CREATE TEMP VIEW commerce_pricing_segment_ty23_12 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
DROP VIEW IF EXISTS commerce_pricing_segment_ty23_1_2;
CREATE TEMP VIEW commerce_pricing_segment_ty23_1_2 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
DROP VIEW IF EXISTS commerce_pricing_segment_ty23_3_4;
CREATE TEMP VIEW commerce_pricing_segment_ty23_3_4 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
WHERE 1 = 1
  ...
  DROP VIEW IF EXISTS commerce_pricing_segment_ty23_5_6;
CREATE TEMP VIEW commerce_pricing_segment_ty23_5_6 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
DROP VIEW IF EXISTS commerce_pricing_segment_ty23_7_8;
CREATE TEMP VIEW commerce_pricing_segment_ty23_7_8 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
WHERE 1 = 1
  ...
  DROP VIEW IF EXISTS commerce_pricing_segment_ty23_9_10;
CREATE TEMP VIEW commerce_pricing_segment_ty23_9_10 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
DROP VIEW IF EXISTS commerce_pricing_segment_ty23_11;
CREATE TEMP VIEW commerce_pricing_segment_ty23_11 as
Select
  domainAttributes.ownerId AS auth_id,
  cast(domainattributes.taxYear as int) AS tax_year,
  domainattributes.originalproductfamily,
...
DROP VIEW IF EXISTS commerce_pricing_segment_ty23_v;
CREATE TEMP VIEW commerce_pricing_segment_ty23_v as
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty23_12
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty23_1_2
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty23_3_4
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty23_5_6
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty23_7_8
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty23_9_10
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7
...
select tax_year
  ...
  , min_rank
  , max_rank
From commerce_pricing_segment_ty23_11
WHERE (min_rank = 1 or max_rank = 1)
Group by 1,2,3,4,5,6,7;

DROP VIEW IF EXISTS commerce_pricing_segment_ty23_v2;
CREATE TEMP VIEW commerce_pricing_segment_ty23_v2 as
...
SELECT
  ...
  FROM commerce_pricing_segment_ty23_v;
...
CREATE table if not exists cgan_ustax_ws.commerce_pricing_segments_ty23_24 as
SELECT *
...
from cgan_ustax_ws.commerce_pricing_segments_ty23_24
group by auth_id, tax_year
...
drop table if exists cgan_ustax_ws.auth_pricing_segment_base_23_24;
create table if not exists cgan_ustax_ws.auth_pricing_segment_base_23_24 as
...
from cgan_ustax_ws.commerce_pricing_segments_ty23_24 a
...
-- DBTITLE 1,Validation Query
select auth_id, count(*)
from cgan_ustax_ws.auth_pricing_segment_base_23_24
group by auth_id, tax_year
having count(*) not in (1,2)

-- COMMAND ----------

-- Auths with only completes = 285,981
...
group by auth_id, tax_year
having count(*) = 1)
where auth_id  in (select auth_id from cgan_ustax_ws.auth_pricing_segment_base_23_24 where metric_type = 'complete')
...
where pam.tax_year IN ('2024','2023')
...
DROP TABLE IF EXISTS cgan_ustax_ws.price_discount_master_23_24;
CREATE TABLE IF NOT EXISTS cgan_ustax_ws.price_discount_master_23_24 USING PARQUET AS
...
Where ft.tax_year in (2023,2024) and ft.order_amount is not null
...
pricing_segment_base AS (
  ...
  FROM cgan_ustax_ws.auth_pricing_segment_base_23_24 a
...
-- How to deal with c.sale_price when metric_type = 'start'
      CASE WHEN a.metric_type = 'complete'  THEN COALESCE(m.total_federal_revenue, b.sale_price, s.sale_price)
  ...
  LEFT JOIN pcode_base b
    ...
    AND a.event_date BETWEEN b.promotion_price_start_date and date_sub(b.promotion_price_end_date,1)
  ...
  LEFT JOIN pricing_segment_base c
    ...
    AND a.sku_rollup_id = c.sku_rollup_id
      AND a.event_date BETWEEN c.promotion_price_start_date and date_sub(c.promotion_price_end_date,1)

  LEFT JOIN pricing_ops_base s
      on a.tax_year = s.tax_year
      AND a.auth_id = s.auth_id
      and a.sku = s.display_sku_name_with_sort
      and s.order_date BETWEEN (a.event_date - INTERVAL 1 DAY) AND (a.event_date + INTERVAL 1 DAY)
...
-- DBTITLE 1,Validation Query - pcode
with pcode_base AS (
  SELECT 
      pcmap.priority_code,
      pcmap.sku_id,
  ...
  WHERE DATE(pcmap.promotion_price_start_date) >= '2023-12-01'
    ...
    AND pcmap.pricing_segment IS NULL 
     ...
     select  priority_code,  display_sku_name_with_sort, date_range_name
from pcode_base
group by priority_code, display_sku_name_with_sort, date_range_name, sku_rollup_id
having count(*) >1
order by 2 desc

-- COMMAND ----------

-- DBTITLE 1,Validation Query - complete pcode


with complete_pcodes as (
Select ft.tax_year
  , ft.auth_id
  , p.completed_sku as sku
  , p.completed_sku_rollup_id as sku_rollup_id
...
left join cgan_ustax_published.pcode_promo_item_mapping dpd 
    on dpc.priority_code = dpd.priority_code 
    and dpa.item_alias_code = dpd.item_alias_code
    and date(ft.order_timestamp) between dpd.promotion_price_start_date and dpd.promotion_price_end_date
    and dpd.product_family_description like '%FEDERAL%'
...
select tax_year, auth_id
from complete_pcodes
group by tax_year, auth_id, sku, sku_rollup_id, first_completed_date
having count(distinct complete_pcode)>1

-- COMMAND ----------

-- DBTITLE 1,Validation Query - pricing segment - sale_price

  with  pricing_segment_base AS (
  SELECT 
      a.tax_year,
      a.auth_id,
      a.metric_type,
  ...
  INNER JOIN (SELECT pcmap.*, sr.display_sku_name_with_sort, sr.sku_rollup_id
            ...
            ON pcmap.sku_id = sr.sku_id
            where pcmap.promotion_name not like '%DO NOT USE%' AND pcmap.promotion_name not like '%ARCHIVE%'
            and pcmap.user_entered_promotion_code not like '%ARCHIVE%'
            ) b
              ON a.pricing_segment = b.pricing_segment
              AND a.sku = b.display_sku_name_with_sort
              AND DATE(b.promotion_price_start_date) >= '2023-12-01'
              AND display_sku_name_with_sort not like '%FULL SERVICE%'
              AND b.product_family_description LIKE '%FEDERAL%'
              AND a.event_datetime BETWEEN b.promotion_price_start_date and date_sub(b.promotion_price_end_date,1)
              --- AND b.discount_value > 0
              AND b.priority_code IS NULL
              AND b.pricing_segment IS NOT NULL
...
-- select *
-- from pricing_segment_base
-- where auth_id = 4697114019288215

select auth_id, count(*)
from pricing_segment_base
group by auth_id, tax_year, metric_type, sku, date_range_name, sku_rollup_id
having count(distinct sale_price) >1


-- COMMAND ----------

-- DBTITLE 1,pricing_segment - discount_type
with  pricing_segment_base AS (
  SELECT 
      a.tax_year,
      a.auth_id,
...
from pricing_segment_base
group by auth_id, tax_year, metric_type, sku, date_range_name, sku_rollup_id
having count(distinct discount_type) >1
...
-- DBTITLE 1,Validation Query - pricing segment - list_price
  with  pricing_segment_base AS (
  SELECT 
      a.tax_year,
      a.auth_id,
...
AND start_sku is null

-- 23566850
select count(distinct auth_id)
from tax_rpt.product_analytics_master
where tax_year in (2023, 2024)
AND start_sku_rollup_id is null
...
from tax_rpt.product_analytics_master
where tax_year in (2023, 2024)
AND completed_sku_rollup_id is null

-- COMMAND ----------

-- DBTITLE 1,Validation Query - pricing ops
with pricing_ops_base as (
    select tax_year, 
            auth_id, 
            order_date,
            display_sku_name_with_sort,
...
(select pricing_ops.*, pcmap.product_family_description, pcmap.sku_id, sr.display_sku_name_with_sort
    ...
    where product_family_description like '%FEDERAL%'
     ...
     select auth_id, count(*)
from pricing_ops_base
group by auth_id, tax_year, display_sku_name_with_sort
having count(*) <>1
