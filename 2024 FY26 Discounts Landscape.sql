...
-- Validate -> Are we connectig the correct priocing segment to the correct auth id
-- auth-> pricing segment
...
-- 142, 143 to be changes after bringing in SAM's table
